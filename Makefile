...
ULIB = $U/ulib.o $U/usys.o $U/printf.o $U/umalloc.o $U/setjmp.o $U/threads.o
...
check-qemu-version:
	@if [ "$(shell awk -v v1="$(QEMU_VERSION)" -v v2="$(MIN_QEMU_VERSION)" 'BEGIN {print (v1 >= v2 ? 1 : 0)}')" -eq 0 ]; then \
